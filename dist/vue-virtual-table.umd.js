(function(global, factory) {
  ...
  _defineProperty(_render$staticRenderF, "methods", {
    ...
    handleClickReverseFilter: function handleClickReverseFilter(index) {
      ...
      var selecetedOptions = this.configTemp[
        index
