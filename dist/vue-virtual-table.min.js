var VueVirtualTable = (function(e, t, i, a, n, r, o, l, s) {
  "use strict";
  function c(e) {
    ...
    computed: {
      ...
      heights: function() {
        if (null === this.itemHeight) {
          for (
            var e = {}, t = this.items, i = this.heightField, a = 0, n = 0;
            n < t.length;
            n++
          )
            (a += t[n][i]), (e[n] = a);
        ...
        this.$_updateDirty ||
          ...
          this.$nextTick(function() {
            ...
            if (a) {
              ...
              if (
                ((e.$_oldScrollTop = u), (e.$_oldScrollBottom = f), null === r)
              ) {
                var h = e.heights,
                  m = 0,
                  v = i - 1,
              ...
              (t ||
                ...
                e.delayPreviousItems
                  ? ((e.visibleItems = n.slice(e.$_startIndex, c)),
                    e.$nextTick(function() {
                      e.visibleItems = n.slice(s, c);
                    }))
                  : (e.visibleItems = n.slice(s, c)),
      ...
      setSize: function() {
        if (this.$refs.popHandler) {
          ...
          t + this.width > window.innerWidth &&
            (r = t + this.width - window.innerWidth),
            (this.offset.left = t - r),
            (this.offset.top = i + a + 10),
            (this.offset.arrowLeft = n / 2 - 6 + r);
        }
      }
    },
    mounted: function() {
  ...
  var T = ((S = {
    ...
    a(S, "methods", {
      updateBase: function() {
        ...
        if (
          ...
          (this.configTemp = e.deepCopy(i)),
            (this.minWidthTemp = a),
            (this.multiConfigTemp = e.deepCopy(n));
        }
        e.parseConfig(),
          e.updateInitData(),
        ...
        var t = (function e(t) {
            ...
            return (
              ...
              Object.keys(t).reduce(function(n, r) {
                var o = i.length ? i + "." : "";
                return (
                  "object" === s(t[r]) && !Array.isArray(t[r]) && a >= 1
                    ? Object.assign(n, e(t[r], o + r, a))
                    : (n[o + r] = t[r]),
                  n
                );
              }, {})
            ...
            try {
              for (
                ...
                !(function(t, r) {
                  ...
                  (o.path = t), (o.name = t), (o.level = i + 1), n.push(o);
                })(f[0], f[1]);
              }
            } catch (e) {
              (o = !0), (c = e);
      ...
      handleExportTable: function() {
        ...
        try {
          for (
            var n, r = this.configTemp[Symbol.iterator]();
            !(t = (n = r.next()).done);
            t = !0
          ) {
            var o = n.value;
        ...
        var s = Object.keys(e),
          c = new Date().toLocaleDateString() + ".csv";
        this.exportCsv(l, s, c);
      },
      parseConfig: function() {
        ...
        e.configTemp.forEach(function(t, i) {
          ...
          if (
            ...
            var n = e.dataInitTemp.reduce(function(e, i) {
                return i && e.push(i[t.prop]), e;
              }, []),
              r = [].concat(o(new Set(n))).sort(function(e, t) {
      ...
      refreshSummary: function() {
        var e = this,
          ...
          a = [];
        (t.showSummary = !1),
          t.configTemp.forEach(function(e, n) {
            var r = e.prop;
            if (e.summary) {
              t.showSummary = !0;
              var o = {};
              switch (((o.prop = r), e.summary)) {
                case "COUNT":
                  (o.value = i), a.push(o);
                  break;
                case "SUM":
                  (o.value = t.dataTemp.reduce(function(e, t) {
                    return isNaN(t[r]) || (e += Number(t[r])), e;
                  }, 0)),
          ...
          t.configTemp.forEach(function(t, i) {
            ...
            if (t.summary) {
              var r = {};
              if (((r.prop = n), /\${[\w-_]+}/.test(t.summary))) {
                var o = t.summary;
        ...
        if (this.$refs && this.$refs.tContainer) {
          ...
          this.configTemp
            ...
            .forEach(function(e, t) {
              "auto" === e.width ? (n += 1) : (a += Number(e.width));
            });
          for (var r = Number(((t - a) / n).toFixed(1)), o = 0; o < i; o++)
            isNaN(
              this.configTemp.filter(function(e) {
                return !e.isHidden;
              })[o].width
            )
              ? (this.colWidth[o] = (100 * r / t).toFixed(1))
              : (this.colWidth[o] = (
                  100 *
                  this.configTemp.filter(function(e) {
                    return !e.isHidden;
