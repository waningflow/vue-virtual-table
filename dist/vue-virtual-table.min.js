var VueVirtualTable = (function(e, t, a, i, r, n, o, l, s) {
  "use strict";
  function c(e) {
    c.installed || ((c.installed = !0), e.component("VueVirtualTable", T));
  }
  ...
  var d = {
    render: function() {
      ...
      return a(
        ...
        [
                ...
                [
                  ...
                  e.renderers
                    ? e._l(e.visibleItems, function(t, i) {
                        return a(e.renderers[t[e.typeField]], {
                          key: (e.keysEnabled && t[e.keyField]) || "",
                          tag: "component",
                          staticClass: "item",
                          attrs: { item: t, "item-index": e.$_startIndex + i }
                        });
                      })
                    : [
          ...
          e._v(" "),
          a("resize-observer", { on: { notify: e.handleResize } })
        ],
        2
      );
    },
    ...
    directives: { ObserveVisibility: a.ObserveVisibility },
    props: {
    ...
    computed: {
      ...
      heights: function() {
        if (null === this.itemHeight) {
          for (
            var e = {}, t = this.items, a = this.heightField, i = 0, r = 0;
            r < t.length;
            r++
          )
            (i += t[r][a]), (e[r] = i);
          ...
          this.$nextTick(function() {
            ...
            if (i) {
              var s = -1,
                ...
                u = ~~(i.top / p) * p - d,
                f = Math.ceil(i.bottom / p) * p + d;
              if (
                !t &&
                ((u === e.$_oldScrollTop && f === e.$_oldScrollBottom) ||
                  e.$_skip)
              )
                return void (e.$_skip = !1);
              if (
                ((e.$_oldScrollTop = u), (e.$_oldScrollBottom = f), null === n)
              ) {
                var h = e.heights,
                  m = 0,
                  v = a - 1,
  ...
  var p = {
    render: function() {
      ...
      return a(
        ...
        [
          a("transition", { attrs: { name: e.animationMode } }, [
            e.isShow
              ? a(
                  "div",
                  {
    ...
    directives: {
      ObserveVisibility: a.ObserveVisibility,
      "click-out-side": {
        bind: function(e, t, a) {
          (e.clickOutsideEvent = function(i) {
            ((e != i.target && !e.contains(i.target)) ||
              a.context.clickToClose) &&
              a.context[t.expression](i);
          }),
  ...
  var y = {
    render: function() {
      ...
      return a(
        ...
        [
          a("title", { attrs: { id: e.iconName, lang: "en" } }, [
  ...
  var _ = {
    ...
    components: { BasePopover: p, BaseIcon: y },
        ...
        e._l(e.choiceList, function(t) {
          return a(
            ...
            [
              ...
              e._v(" "),
              a("div", { staticClass: "check-label" }, [e._v(e._s(t))])
            ]
          );
        })
      );
      ...
      render: function() {
        ...
        return a(
          ...
          [
                ...
                a("div", { staticClass: "t-header" }, [
                  a(
                    ...
                    [
                      ...
                      e._v(" "),
                      e.enableMultiHeader
                        ? e._l(e.multiConfigTemp, function(t, i) {
                            return a(
                              "div",
                              { key: i, staticClass: "header-line" },
                              e._l(t, function(t, i, r) {
                                return a(
                                  "div",
                                  {
                                    key: i,
            ...
            e._v(" "),
            a("div", { staticClass: "clipboard" }, [
              a("input", { ref: "clipboardInput", attrs: { type: "text" } })
            ]),
            e._v(" "),
            a("resize-observer", { on: { notify: e.setSize } })
          ],
          1
        );
      },
    ...
    i(S, "methods", {
        ...
        var t = (function e(t) {
            ...
            return (
              ...
              Object.keys(t).reduce(function(r, n) {
                var o = a.length ? a + "." : "";
                return (
                  "object" === s(t[n]) && !Array.isArray(t[n]) && i >= 1
                    ? Object.assign(r, e(t[n], o + n, i))
                    : (r[o + n] = t[n]),
                  r
                );
              }, {})
                ...
                !(function(t, n) {
                  ...
                  if (
                    ...
                    (c = c.map(function(e) {
                      ...
                      (o.rowspan = 1),
                      (o.colspan = l);
                  } else (o.rowspan = i), (o.colspan = 1);
                  (o.path = t), (o.name = t), (o.level = a + 1), r.push(o);
                })(f[0], f[1]);
              }
            } catch (e) {
              (o = !0), (c = e);
          ...
          c = Object.values(n);
        return { config: i, width: a, multiConfig: c };
      },
              ...
              function(e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 4:
                      if (
                        ((a = this.$refs.clipboardInput),
                        (a.value = t),
                        a.focus(),
                        a.select(),
                        "unsuccessful" !== (i = document.execCommand("copy")))
                      ) {
                        e.next = 11;
                        break;
                      }
      ...
      s2ab: function(e) {
        if ("undefined" != typeof ArrayBuffer) {
          for (
            var t = new ArrayBuffer(e.length), a = new Uint8Array(t), i = 0;
            i != e.length;
            ++i
          )
            a[i] = 255 & e.charCodeAt(i);
          return t;
        }
      ...
      parseConfig: function() {
        var e = this;
        e.configTemp.forEach(function(t, a) {
          var i =
          ...
          if (
            ...
            var r = e.dataInitTemp.reduce(function(e, a) {
                return a && e.push(a[t.prop]), e;
              }, []),
            ...
            for (
              var l = i.filterSelectedOptions || [], s = l.length - 1;
              s >= 0;
              s--
            )
          ...
          if (t.searchable) {
            var c = i.searchPhrase || [{ operator: "in", value: "" }];
            e.$set(t, "searchPhrase", c), e.$set(t, "searchVisible", !1);
          }
          if (t.numberFilter) {
            var d = i.numberFilterPhrase || { operator: "le", value: ["", ""] };
      ...
      updateInitData: function() {
        var e = this,
          t = this;
        t.dataInitTemp.forEach(function(a, i) {
          (a._eId = t._uuid()),
            (a._eSelected = !1),
            e.defaultSelect &&
              e.defaultSelect.indexOf(i) > -1 &&
              (a._eSelected = !0),
            (a._eClass = {}),
            t.configTemp.forEach(function(e, i) {
              e.eClass && (a._eClass[e.prop] = t.parseClass(e.eClass, a));
            });
        });
      },
      ...
      refreshSummary: function() {
        ...
        (t.showSummary = !1),
          ...
          t.configTemp.forEach(function(t, a) {
            var r = t.prop;
            if (t.summary) {
              var n = {};
      ...
      selectAll: function() {
        ...
        var t = [];
        this.dataTemp.forEach(function(a) {
          a._eSelected = e;
          var i = a._eId;
          t.push(i);
        }),
      ...
      handleClickItem: function(e) {
        ...
        (e._eSelected = !e._eSelected && this.selectable),
          (t.dataInitTemp.filter(function(t, a) {
            return t._eId === e._eId;
          })[0]._eSelected =
            e._eSelected),
          (t.dataTemp.filter(function(t, a) {
            return t._eId === e._eId;
          })[0]._eSelected =
            e._eSelected),
          ...
          if (
            (e.filterSelectedOptions &&
              ...
              (a = a.filter(function(t) {
                return e.filterSelectedOptions.indexOf(t[i]) > -1;
              })),
            e.searchPhrase &&
            ...
            switch (e.numberFilterPhrase.operator) {
              case "eq":
                a = a.filter(function(t) {
                  return Number(t[i]) == Number(e.numberFilterPhrase.value[0]);
                });
                break;
              case "neq":
                a = a.filter(function(t) {
              ...
              case "bt":
                a = a.filter(function(t) {
                  return (
                    Number(t[i]) > Number(e.numberFilterPhrase.value[0]) &&
                    Number(t[i]) <= Number(e.numberFilterPhrase.value[1])
                  );
                });
            }
        }),
      ...
      handleClickReverseFilter: function(e) {
        var t = this.configTemp[e].filterOptions.slice(),
          a = this.configTemp[e].filterSelectedOptions.slice();
      ...
      handleClickSort: function(e, t, a) {
        var i = this;
        if (
          (i.sortParam.col !== e || i.sortParam.direction !== t || a) &&
          i.dataTemp[0] &&
          e
        ) {
          (i.sortParam.col = e), (i.sortParam.direction = t);
          var r = !1;
          i.dataTemp.some(function(t, a) {
            return (
              !(!t[e] && 0 != t[e]) &&
      ...
      setSize: function() {
        if (this.$refs && this.$refs.tContainer) {
          ...
          var a = this.configTemp.filter(function(e) {
              return !e.isHidden;
            }).length,
            i = 0,
            r = 0;
          this.configTemp
            ...
            .forEach(function(e, t) {
              "auto" === e.width ? (r += 1) : (i += Number(e.width));
            });
          for (var n = Number(((t - i) / r).toFixed(1)), o = 0; o < a; o++)
            isNaN(
